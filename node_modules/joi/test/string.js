    ...
    describe('#validate', function () {
        ...
        it('validates uri', function (done) {
            ...
            Helper.validate(schema, [
                ...
                ['http://asdf:qw%20er@0.0.0.0:8000?asdf=12345&asda=fc%2F#bacon', true],
                ['http://asdf@0.0.0.0:8000', true],
                ...
                ['http://asdf:qwer@0.0.0.0:8000', true],
                ['http://user:pass%3A@0.0.0.0:80', true],
                ['http://0.0.0.0:123', true],
                ['https://0.0.0.0:123', true],
                ['file:///whatever', true],
                ...
                ['http://0.0.0.0:18/asdf', true],
                ['http://0.0.0.0:42/asdf?qwer=zxcv', true],
