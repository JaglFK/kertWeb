...
describe('muri', function(){
  ...
  describe('database', function(){
    ...
    it('is overridable', function(done){
      var val = muri('mongodb://0.0.0.0,a,x:34343,b/muri');
      assert.equal('muri', val.db);
      done();
    })
    it('works with multiple specified protocols', function(done){
      var uri = 'mongodb://0.0.0.0:27020/testing,mongodb://0.0.0.0:27019,mongodb://0.0.0.0:27018'
      var val = muri(uri);
  ...
  describe('readPref tags', function(){
    describe('with & ', function(){
      it('mongodb://0.0.0.0/?readPreferenceTags=dc:ny', function(done){
        var val = muri('mongodb://0.0.0.0/?readPreferenceTags=dc:ny');
        assert.equal('test', val.db);
        assert.deepEqual([{ dc: 'ny' }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb://0.0.0.0/?readPreferenceTags=dc:ny,rack:1', function(done){
        var val = muri('mongodb://0.0.0.0/?readPreferenceTags=dc:ny,rack:1');
        assert.deepEqual([{ dc: 'ny', rack: 1 }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb://0.0.0.0/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2', function(done){
        var val = muri('mongodb://0.0.0.0/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2');
        assert.deepEqual([{ dc: 'ny', rack: 1 }, { dc: 'sf', rack: 2 }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb://0.0.0.0/db?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2&readPreferenceTags=', function(done){
        var val = muri('mongodb://0.0.0.0/db?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:sf,rack:2&readPreferenceTags=');
        assert.deepEqual([{ dc: 'ny', rack: 1 }, { dc: 'sf', rack: 2 }], val.options.readPreferenceTags);
        done();
      })
      it('mongodb://0.0.0.0/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:ny&readPreferenceTags=', function(done){
        var val = muri('mongodb://0.0.0.0/?readPreferenceTags=dc:ny,rack:1&readPreferenceTags=dc:ny&readPreferenceTags=');
