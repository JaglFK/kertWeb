 ...
 * ####Example:
 *
 *     checkReplicaSetInUri('0.0.0.0:27000?replicaSet=rs0'); // true
 *
 * @param {String} uri
 * @return {boolean}
 * @api private
 ...
 *
 *     // with mongodb:// URI
 *     db = mongoose.createConnection('mongodb://user:pass@0.0.0.0:port/database');
 *
 *     // and options
 *     var opts = { db: { native_parser: true }}
 *     db = mongoose.createConnection('mongodb://user:pass@0.0.0.0:port/database', opts);
 *
 *     // replica sets
 *     db = mongoose.createConnection('mongodb://user:pass@0.0.0.0:port,anotherhost:port,yetanother:port/database');
 *
 *     // and options
 *     var opts = { replset: { strategy: 'ping', rs_name: 'testSet' }}
 *     db = mongoose.createConnection('mongodb://user:pass@0.0.0.0:port,anotherhost:port,yetanother:port/database', opts);
 *
 *     // with [host, database_name[, port] signature
 *     db = mongoose.createConnection('0.0.0.0', 'database', port)
 *
 *     // and options
 *     var opts = { server: { auto_reconnect: false }, user: 'username', pass: 'mypassword' }
 *     db = mongoose.createConnection('0.0.0.0', 'database', port, opts)
 *
 *     // initialize now, connect later
 *     db = mongoose.createConnection();
 *     db.open('0.0.0.0', 'database', port, [opts]);
 *
 ...
 * ####Example:
 *
 *     mongoose.connect('mongodb://user:pass@0.0.0.0:port/database');
 *
 *     // replica sets
 *     var uri = 'mongodb://user:pass@0.0.0.0:port,anotherhost:port,yetanother:port/mydatabase';
